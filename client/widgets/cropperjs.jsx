...
//Adapted from TAPP-TV/react-cropperjs Copyright (c) 2016 Tapp TV

const CropperJS = createReactClass({
  ...
  componentDidMount() {
    ...
    this.cropper = new Cropper(this.node, options);
  },
    ...
    return (
      <div
        ...
        <img
          ...
          src={this.props.src}
          alt={this.props.alt === undefined ? 'picture' : sanitise(this.props.alt)}
          style={imgStyle} />
      </div>
    );
  }
